...
static const char *default_dns_server = "119.29.29.29,223.6.6.6,223.5.5.5,8.8.8.8,8.8.4.4";
...
\n\
  ...
  -s DNS                DNS server to use, default: 119.29.29.29,223.6.6.6,223.5.5.5,8.8.8.8,8.8.4.4\n\
